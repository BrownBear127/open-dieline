...
const GATES = ['g1-parity', 'g2-vocab', 'g3-utility', 'g4-export-isolation', 'g5-forbidden-words', 'g6-external-urls', 'charset', 'a9-contrast', 'a15-copy', 'j1-bundle'];
...
// font-gate（py）＋A8 bytes 預算（值=法蘭 T8 checkpoint 裁定 346,076B，Spec §6.3）
