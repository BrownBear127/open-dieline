 ...
 * [33,35.396) 這個窗口時 B 款 longWall 插底舌已實際自撞但不變式仍回報正常（SOL
 * re-review Medium finding，2026-07-11：baseLength=34＋basePlatformWidth=0 實測驗證，
 * 見 task-4-fix-report.md concern 1 fix 段的重現紀錄；已用 generateTray+
