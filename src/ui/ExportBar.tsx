 ...
 *
 * 「含尺寸標註」checkbox 已於 Slice 3 gate round 1 T2 退役（原本 T9 樣張 gate 第二輪法蘭
 * 反饋修復 3 把這顆 checkbox 的 state 提升到 App.tsx、同時餵給 Canvas，讓下載內容與畫布
 * 顯示同步）。gate round 1 法蘭反饋把「顯示哪些線型」升級成 LayersPanel 的圖層可見性
 ...
 * 分層 SVG 自行隱藏/刪除該圖層（T4 才接手 g 分組，本 task 尚未分組，SVG 匯出內容暫時
 * 仍是平鋪、恆含標註）。
 *
