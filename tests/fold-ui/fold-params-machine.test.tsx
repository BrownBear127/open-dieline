...
describe('FoldView B4-machine parameter linkage', () => {
  ...
  // tuckLock 暫不驗區分性（BLOCKED-ON-2026-07-17）：2D frictionLock 的摺線本身分裂
  ...
  it.todo('tuckLock changes the received model dimension — BLOCKED-ON-維護者（validator 單邊含中點規則 vs 2D 分裂 crease）');
