 ...
 * strideY 因此有真實收縮空間；strideX 無收縮空間的成因（T2 review Low 2 修正原述）：
 ...
 *
 * RTE 真實幾何在任何紙規下**最終擇優結果**皆無正數補排（T2 review Low 1 修正原
 * 「任何候選」過強表述——未獲選的矩形候選確實可能補排，如 usable 500×494 的 0° 矩形
 * 候選=主格 2＋底排 1，但行縮候選主格 4 必勝出；review 掃整數紙規＋200 萬組隨機連續紙規
 ...
 * 平手時 gridCount／行縮規則勝出）。這正是 spec「找不到真實正補排案例」退回人造
